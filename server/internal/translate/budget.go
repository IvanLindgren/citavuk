...
// обновления.
//
// Миллион — это месячный лимит ключа, а не удвоение с запасом: /v2/usage
// отвечает character_limit=1000000. Меняешь ключ на другой план — правь и
// здесь, либо задай CITAVUK_DEEPL_RUNES_PER_DAY на сервере, без пересборки.
