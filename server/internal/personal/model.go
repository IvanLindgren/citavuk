...
var Questions = []Question{
	{"goal", "Для чего тебе сербский?", []string{"Жизнь в Сербии", "Работа", "Путешествия", "Учёба и экзамены", "Семья и общение", "Культура"}},
	{"focus", "На что сделать упор?", []string{"Понемногу на всё", "Чтение", "Грамматика", "Лексика", "Понимание речи", "Письмо"}},
	{"minutes", "Сколько времени в день удобно заниматься?", []string{"5 минут", "10 минут", "20 минут"}},
	{"pace", "Какой темп тебе подходит?", []string{"Спокойный", "Сбалансированный", "Интенсивный"}},
	{"script", "Какую письменность будем использовать?", []string{"Латиница", "Кириллица", "Обе"}},
	{"explanation", "Какие объяснения тебе помогают?", []string{"Коротко и по делу", "Подробно с примерами", "Схемы и сравнения с русским"}},
	{"difficulty", "Что пока труднее всего?", []string{"Падежи", "Глаголы и времена", "Не хватает слов", "Понимать живую речь", "Строить предложения"}},
	{"practice", "Какие задания тебе ближе?", []string{"Выбирать ответ", "Писать самому", "Чередовать разные задания"}},
	{"topics", "Какие темы тебе интереснее?", []string{"Повседневная жизнь", "Еда и путешествия", "История и культура", "Новости и политика", "Работа и технологии", "Юмор и разговорная речь"}},
	{"result", "Какого результата ждёшь через месяц?", []string{"Меньше бояться общения", "Лучше читать", "Разобраться в грамматике", "Расширить словарь", "Закрепить привычку"}},
}
