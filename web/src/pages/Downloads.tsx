...
type Platform = {
  ...
  href?: string;
  /** Своя версия, если она разошлась с общей — в любую сторону. */
  version?: string;
  size?: string;
  note?: string;
...
const PLATFORMS: Platform[] = [
  {
    ...
    note:
      ...
      'установить, то удалите старую версию, перед этим перенеся ваши книги в ' +
      'аккаунт. Затем скачайте и установите приложение.',
  },
  {
    id: 'windows',
    title: 'Windows',
  ...
  },
  {
    ...
    version: '1.18.0',
    size: '57 МБ',
    note: 'Beta пока не подписана Apple Developer ID. При первом запуске нажмите приложение правой кнопкой, выберите «Открыть» и подтвердите запуск. Сборка на версию отстаёт — обновим, как только соберётся.',
  },
  {
    id: 'ios',
    title: 'iPhone и iPad',
