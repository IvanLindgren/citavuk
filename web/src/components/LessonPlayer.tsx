...
function Exercise({ exercise, index, lesson, preview }: { exercise: LessonExercise; index: number; lesson: Lesson; preview: boolean }) {
...
function ExerciseBody({ exercise, lesson, preview }: { exercise: LessonExercise; lesson: Lesson; preview: boolean }) {
  ...
  if (exercise.type === 'teacher_letter') return <TeacherLetter exercise={exercise} lesson={lesson} preview={preview} />;
